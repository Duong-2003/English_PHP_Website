...
<head>
    ...
    <style>
        ...
        .dropdown-menu {
            ...
            z-index: 999; /* Đảm bảo dropdown không bị che khuất */
        }
        ...
        <div class="container d-flex justify-content-between align-items-center py-2">
            ...
            <nav class="d-none d-lg-flex gap-3">
                ...
                <?php if (isset($user)): ?>
                    ...
                    <a href="../project/profile_english.php" class="nav-link">
                        <img src="../public/images/icons/ic_default_ava_male.png" alt="User Avatar" class="user-avatar"> 
                        <?php echo htmlspecialchars($user['username']); ?>
                    </a>
                    <a href="../project/logout.php" class="nav-link">Logout</a>
                <?php else: ?>
            ...
            <div class="d-lg-none">
                ...
                <div id="mobile-menu" class="dropdown-menu position-absolute bg-white shadow-lg mt-2" style="display: none;">
                    <a class="dropdown-item" href="../project/website.php">Start</a>
