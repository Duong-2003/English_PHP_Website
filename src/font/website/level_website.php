...
<section class="py-5">
    ...
    <div class="d-flex flex-column flex-lg-row justify-content-center gap-4">
        ...
        <div class="bg-white rounded-3xl text-center shadow-lg p-4">
            <div class="rounded-circle bg-white p-2 mx-auto mb-4 shadow-md" style="width: 80px; height: 80px;">
                <img src="<?= '../public/images/icons/ic_beginner.png' ?>" alt="Sơ cấp" class="img-fluid">
            </div>
            <h5 class="font-weight-bold mb-3">Sơ cấp</h5>
        ...
        <div class="bg-white rounded-3xl text-center shadow-lg p-4">
            ...
            <h5 class="font-weight-bold mb-3">Trung cấp</h5>
        ...
        <div class="bg-white rounded-3xl text-center shadow-lg p-4">
            ...
            <h5 class="font-weight-bold mb-3">Cao cấp</h5>
