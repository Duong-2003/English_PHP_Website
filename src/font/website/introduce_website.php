...
<head>
    ...
    <style>
        ...
        .bg-colorLandingEmerald {
            background-color: #4caf50; /* Thay đổi màu sắc theo yêu cầu */
        }
        .bg-colorLandingBlue {
...
<section class="d-flex flex-column flex-lg-row align-items-start pt-4 pb-4 position-relative">
    <div class="shrink-0 mb-4 mb-md-0 mr-lg-5 lg:mr-4 xl:mr-5">
    ...
    <div class="d-none d-lg-block position-absolute" style="width: 200px; height: 200px; background-color: rgba(76, 175, 80, 0.5); border-radius: 50%; top: 25%; left: -10%; filter: blur(50px);"></div>
    <div class="d-none d-lg-block position-absolute" style="width: 200px; height: 200px; background-color: rgba(33, 150, 243, 0.5); border-radius: 50%; top: 10%; left: 20%; filter: blur(50px);"></div>
</section>
